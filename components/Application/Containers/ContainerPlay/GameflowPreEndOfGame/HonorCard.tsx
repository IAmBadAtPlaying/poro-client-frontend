...
import styles from '../../../../../styles/Application/Containers/ContainerPlay/GameflowPreEndOfGame/HonorCard.module.css';
...
export default function HonorCard(
    ...
    const honorPlayer = (honorType: string) => {
        ...
        axios.post(Globals.PROXY_PREFIX+'/lol-honor-v2/v1/honor-player', honor)
            .then((response) => {
                setTimeout(() => {
